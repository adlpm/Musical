<template>
  <div class="score">
    ...
    >
      ...
      <div class="text">
        <div class="outrun glow">SCORES</div>

        <div class="chrome shine">
          <span class="spark"></span>
          <p v-for="score in topScores" :key="score">
            {{ score }}
          </p>
        </div>
      </div>
...
@font-face {
  ...
  font-weight: normal;
  src: local("RoadRage"),
    url("https://coding-dude.com/wp/wp-content/uploads/Road_Rage.woff")
      format("woff");
}
